            ...
            <S.PlayerControls>
              <S.PlayerControlWithRightMargin>
                <S.PlayerSvgPrev alt="prev" onClick={handlePrevClick}>
                  <svg>
                    <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-prev"></use>
                  </svg>
                </S.PlayerSvgPrev>
              </S.PlayerControlWithRightMargin>
              <S.PlayerControlWithRightMargin className="_btn">
                {playing ? (
                  ...
                  <S.PlayerSvgPlay onClick={play} alt="play">
                    <svg>
                      <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-play"></use>
                    </svg>
                  </S.PlayerSvgPlay>
                )}
              </S.PlayerControlWithRightMargin>
              <S.PlayerNextIcon>
                <S.PlayerSvgNext alt="next" onClick={handleNextClick}>
                  <svg>
                    <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-next"></use>
                  </svg>
                </S.PlayerSvgNext>
              </S.PlayerNextIcon>
              <S.PlayerRepeatIcon className="_btn-icon" onClick={toggleLoop}>
                <S.PlayerSvgRepeat alt="repeat" $active={isLooped}>
                  <svg>
                    <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-repeat"></use>
                  </svg>
                </S.PlayerSvgRepeat>
              </S.PlayerRepeatIcon>
              <S.PlayerShuffleIcon className="_btn-icon">
                ...
                >
                  <svg>
                    <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-shuffle"></use>
                  </svg>
                </S.PlayerSvgShuffle>
              </S.PlayerShuffleIcon>
            </S.PlayerControls>
              ...
              <S.TrackContain>
                <S.TrackPlayImage>
                  <S.TrackPlaySvg alt="music">
                    <svg>
                      <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-note"></use>
                    </svg>
                  </S.TrackPlaySvg>
                </S.TrackPlayImage>
                <S.TrackPlayAuthor>
                ...
                {!isTrackLiked ? (
                  <S.TrackLike className="_btn-icon" onClick={likeCurrentTrack}>
                    <S.TrackLikeSvg alt="like">
                      <svg>
                        <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-like"></use>
                      </svg>
                    </S.TrackLikeSvg>
                  </S.TrackLike>
                ) : (
                  ...
                  >
                    <S.TrackLikeSvg alt="dislike">
                      <svg>
                        <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-dislike"></use>
                      </svg>
                    </S.TrackLikeSvg>
                  </S.TrackDislike>
                )}
            ...
            <S.VolumeContent>
              <S.VolumeImage>
                <S.VolumeSvg alt="volume">
                  <svg>
                    <use xlinkHref="/webdev-react-hw/img/icon/sprite.svg#icon-volume"></use>
                  </svg>
                </S.VolumeSvg>
              </S.VolumeImage>
